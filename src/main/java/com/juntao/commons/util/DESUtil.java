...
public class DESUtil {
    ...
    public static String encrypt(String plainData, String secretKey) throws Exception {
        ...
        try {
            ...
            // 不能把加密后的字节数组直接转换成字符串
            byte[] buf = cipher.doFinal(plainData.getBytes(SConsts.UTF_8));
    ...
    public static String decrypt(String secretData, String secretKey) throws Exception {
        ...
        try {
            ...
            return new String(buf, SConsts.UTF_8);
    ...
    private static SecretKey generateKey(String secretKey)
        ...
        DESKeySpec keySpec = new DESKeySpec(secretKey.getBytes(SConsts.UTF_8));
